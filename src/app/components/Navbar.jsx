...
const Navbar = () => {
  return (
    <nav className="bg-pink-100 shadow-md py-3 px-6">
      {/* Desktop Layout */}
      ...
      <div className="flex flex-wrap justify-center gap-6 mx-4">
        <Link className="text-gray-700 hover:text-pink-600" href="/category/Amateur">Amateur</Link>
        <Link className="text-gray-700 hover:text-pink-600" href="/category/Anal">Anal</Link>
        <Link className="text-gray-700 hover:text-pink-600" href="/category/Asian">Asian</Link>
        <Link className="text-gray-700 hover:text-pink-600" href="/category/new">New</Link>
      </div>
    </nav>
  );
};
